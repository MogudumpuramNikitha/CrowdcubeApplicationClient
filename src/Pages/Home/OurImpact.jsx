...
const OurImpact = () => {
  return (
    <>
      {" "}
      <section className="our-impact py-16 bg-gradient-to-r from-blue-50 via-white to-blue-50 dark:bg-gray-800 ">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold text-center text-blue-600 dark:text-blue-300 mb-12">
            Our Impact
          </h2>
